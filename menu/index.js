        ...
        <div className='text-white'>
          <div className='flex p-2  bg-gray-800'>
            <div className='flex py-3 px-2 items-center'>
              <p className='text-2xl text-green-500 font-semibold'>WS</p>
              <p className='ml-2 font-semibold italic'>OrganizaVida</p>
            </div>
          </div>
          <div className='flex justify-center'>
            <div className=''>
              <img className='hidden h-24 w-24 rounded-full sm:block object-cover mr-2 border-4 border-green-400'
                  src='https://image.flaticon.com/icons/png/512/149/149071.png' alt='foto usuario'/>
              <p className='font-bold text-base  text-gray-400 pt-2 text-center w-24'>Walker</p>
            </div>
          </div>
          <div>
            <ul className='mt-6 leading-10'>
              ...
              <li className='relative px-2 py-1'>
                <div className='inline-flex items-center justify-between w-full text-base font-semibold transition-colors duration-150 text-gray-500  hover:text-yellow-400 cursor-pointer'>
                  ...
                  {dropdownOpen &&
                  <svg xmlns='http://www.w3.org/2000/svg' onClick={close}
                ...
                {!dropdownOpen &&
                  <svg xmlns='http://www.w3.org/2000/svg' onClick={open}
                      className='ml-1  text-white w-4 h-4' fill='none' viewBox='0 0 24 24'
                      stroke='currentColor'>
                      <path strokeLinecap='round' strokeLinejoin='round' strokeWidth='2'
                          d='M19 9l-7 7-7-7' />
